font_data = {
    ...
    'E': [0xFE, 0x60, 0x60, 0xF8, 0x60, 0x60, 0xFE, 0x00],
    'F': [0xFE, 0x60, 0x60, 0xF8, 0x60, 0x60, 0x60, 0x00],
    'G': [0x3C, 0x66, 0xC0, 0xCE, 0xC6, 0x66, 0x3E, 0x00],
    'H': [0xC6, 0xC6, 0xC6, 0xFE, 0xC6, 0xC6, 0xC6, 0x00],
    'I': [0x7E, 0x18, 0x18, 0x18, 0x18, 0x18, 0x7E, 0x00],
    'J': [0x0E, 0x06, 0x06, 0x06, 0xC6, 0xC6, 0x7C, 0x00],
    ...
    'Q': [0x38, 0x6C, 0xC6, 0xC6, 0xC6, 0x6C, 0x38, 0x06],
    'R': [0xFC, 0x66, 0x66, 0xFC, 0x6C, 0x66, 0xC6, 0x00],
    'S': [0x7C, 0xC6, 0x60, 0x38, 0x0C, 0xC6, 0x7C, 0x00],
    'T': [0xFE, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x00],
    ...
    'Y': [0xC6, 0xC6, 0xC6, 0x7C, 0x18, 0x18, 0x18, 0x00],
    'Z': [0xFE, 0x0C, 0x18, 0x30, 0x60, 0xC0, 0xFE, 0x00],
    'a': [0x00, 0x00, 0x78, 0x0C, 0x7C, 0xCC, 0x76, 0x00],
    'b': [0xE0, 0x60, 0x78, 0x6C, 0x66, 0x6C, 0x78, 0x00],
    'c': [0x00, 0x00, 0x78, 0xC0, 0xC0, 0xC0, 0x78, 0x00],
    'd': [0x0E, 0x06, 0x3E, 0x66, 0x66, 0x66, 0x3E, 0x00],
    ...
    'h': [0xE0, 0x60, 0x78, 0x6C, 0x66, 0x66, 0x66, 0x00],
    'i': [0x18, 0x18, 0x00, 0x38, 0x18, 0x18, 0x7E, 0x00],
    'j': [0x0C, 0x0C, 0x00, 0x1C, 0x0C, 0x0C, 0x0C, 0x78],
    'k': [0x60, 0x60, 0x66, 0x6C, 0x78, 0x6C, 0x66, 0x00],
    'l': [0x38, 0x18, 0x18, 0x18, 0x18, 0x18, 0x7E, 0x00],
    'm': [0x00, 0x00, 0xEC, 0xFE, 0xD6, 0xD6, 0xD6, 0x00],
    'n': [0x00, 0x00, 0xB8, 0xCC, 0xCC, 0xCC, 0xCC, 0x00],
    ...
    '9': [0x3E, 0x63, 0x63, 0x3F, 0x03, 0x06, 0x1C, 0x00],
...
out = "#ifndef VEXTRYN_FONT_H\n#define VEXTRYN_FONT_H\n\n#include <stdint.h>\n\nstatic const uint8_t font8x8[256][8] = {\n"
for i in range(256):
    c = chr(i) if 32 <= i < 127 else ' '
    data = font_data.get(c, font_data[' '])
    out += "    {" + ", ".join(f"0x{b:02x}" for b in data) + "},\n"
out += "};\n\n#endif\n"

with open('gui/compositor/font8x8.h', 'w') as f:
    f.write(out)
